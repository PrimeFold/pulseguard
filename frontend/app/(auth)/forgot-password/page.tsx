...
export default function ForgotPasswordPage() {
 ...
 setLoading(true);
 setError("");
 // Use requestPasswordReset to hit the /api/auth/request-password-reset endpoint
 ...
 <div className="flex items-start gap-2 p-4 bg-white-950/20 border border-white-900/50">
 <Check className="h-4 w-4 text-white shrink-0 mt-0.5" />
 <p className="text-[11px] font-mono text-zinc-200 uppercase tracking-widest leading-relaxed">
 ...
 <div className="h-10 w-10 bg-zinc-900 flex items-center justify-center rounded-xl border border-zinc-800">
