...
function ResetPasswordForm() {
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-white hover:bg-zinc-200 text-black border border-transparent font-mono text-xs font-bold tracking-widest uppercase rounded-xl h-9 mt-2 transition-all duration-300 active:scale-[0.98] cursor-pointer"
 >
 {loading ? (
