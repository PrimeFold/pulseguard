...
export default async function AuthLayout({
 ...
 <div className="h-6 w-6 bg-white flex items-center justify-center rounded-xl transition-transform group-hover:rotate-90 duration-300">
 ...
 <div className="flex items-center gap-1.5 px-2 py-1 bg-zinc-950 border border-zinc-800/80 rounded-xl">
 <span className="h-1.5 w-1.5 rounded-xl bg-white text-black animate-pulse" />
