...
export default function SignUpPage() {
 ...
 Initialize your developer credentials to manage incident war
 rooms.
 </p>
 </div>
 ...
 required
 className="bg-zinc-900 border-zinc-800 text-zinc-100 text-xs rounded-xl h-9 font-sans placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-700"
 />
 </div>
 ...
 required
 className="bg-zinc-900 border-zinc-800 text-zinc-100 text-xs rounded-xl h-9 font-mono placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-700"
 />
 </div>
 ...
 required
 minLength={8}
 className="bg-zinc-900 border-zinc-800 text-zinc-100 text-xs rounded-xl h-9 font-mono placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-700 pr-9"
 />
 <button
 type="button"
 ...
 <div
 ref={errorRef}
 className="p-3 bg-red-950/30 border border-red-900/40 text-red-400 text-xs font-mono flex items-start gap-2 rounded-xl"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-white hover:bg-zinc-200 text-black border border-transparent font-mono text-xs font-bold tracking-wider rounded-xl h-9 transition-all duration-200 active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2"
 >
 {loading ? (
 ...
 <Terminal className="h-3 w-3 text-white" /> PROVISIONING
 </span>
 <span className="text-[9px] font-mono text-zinc-200 bg-white-950/40 border border-white-900/40 px-1.5 py-0.5 rounded-xl font-semibold">
 READY
 </span>
 </div>
 ...
 All logs, embeddings, and stack traces remain isolated to your
 organizations.
 </p>
 </div>
 ...
 <p className="text-zinc-300">
 Optionally connect your personal Google, OpenAI, or Anthropic
 provider keys.
 </p>
 </div>
 </div>
 ...
 <ShieldCheck className="h-4 w-4 text-zinc-200 shrink-0" />
 <span className="text-[11px] font-medium text-zinc-300">
 Security Commitment
 </span>
 </div>
 <p className="text-[10px] text-zinc-500 font-sans leading-relaxed">
 PulseGuard never executes non-approved git patches. PRs require
