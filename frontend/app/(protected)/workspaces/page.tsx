      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-16 space-y-12">
        ...
        <header className="flex items-center justify-between border-b border-zinc-800/80 pb-6">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 bg-white flex items-center justify-center rounded-none transition-transform hover:rotate-90 duration-300 shadow-sm">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="space-y-5">
              <div className="flex items-end justify-between border-b border-zinc-800/60 pb-4">
                ...
                <Link
                  href="/workspaces/new"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-zinc-200 text-black font-mono text-xs font-bold tracking-wider transition-all duration-300 hover:-translate-y-[1px] active:scale-[0.98] rounded-none cursor-pointer shadow-sm"
                >
              ...
              {memberships.length === 0 ? (
                <div className="p-12 text-center border border-dashed border-zinc-800 bg-zinc-950/30 rounded-none">
                ...
                <div className="divide-y divide-zinc-900 border border-zinc-800 bg-zinc-950/50 rounded-none overflow-hidden shadow-lg">
                  {memberships.map(({ organization: org, role }: any) => (
                    ...
                    >
                      <div className="flex items-center gap-4 sm:gap-5">
                        <div className="h-11 w-11 bg-zinc-900/90 border border-zinc-800 flex items-center justify-center rounded-none group-hover:border-zinc-600 group-hover:bg-zinc-800/80 transition-all duration-300 shrink-0">
                      ...
                      <div className="flex items-center gap-4 sm:gap-6">
                        <Badge
                          variant="outline"
                          className="text-xs bg-zinc-900/80 border-zinc-700/80 text-zinc-300 uppercase font-mono tracking-wider rounded-none py-1 px-3"
                        >
                          {role}
                        </Badge>
            ...
            <div className="space-y-5">
              ...
              {memberships.length === 0 ? (
                ...
                <div className="border border-zinc-800 bg-zinc-950/50 overflow-hidden font-mono text-xs sm:text-sm rounded-none shadow-md">
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-4 text-right">
                              {hasKey ? (
                                <span className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-400 bg-emerald-950/40 border border-emerald-800/50 px-2.5 py-1 rounded-none">
                                  <Check className="h-3.5 w-3.5" /> ACTIVE
                                </span>
                              ) : (
                                <span className="inline-flex items-center gap-1.5 text-xs font-bold text-zinc-400 bg-zinc-900/80 border border-zinc-800 px-2.5 py-1 rounded-none">
