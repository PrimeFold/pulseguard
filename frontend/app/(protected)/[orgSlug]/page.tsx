...
export default async function OrgOverviewPage({ params }: OverviewPageProps) {
 ...
 <Activity className="h-6 w-6 sm:h-7 sm:w-7 text-white shrink-0" /> SRE Telemetry Grid
 </h1>
 ...
 prefetch={true}
 className="group flex items-center justify-between gap-4 px-5 py-3.5 bg-red-950/30 border border-red-900/60 hover:bg-red-900/40 transition-all rounded-xl active:scale-[0.98] shrink-0"
 >
