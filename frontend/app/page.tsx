...
export default function LandingPage() {
 ...
 <Link
 href="/docs"
 className="text-white hover:text-zinc-200 underline transition-colors inline-flex items-center gap-1 font-medium"
 >
 ...
 PulseGuard<span className="text-white">_</span>
 </span>
 </Link>
 ...
 className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 border border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-700 transition-colors rounded-xl"
 >
 ...
 {/* Ambient Top Glow */}
 <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 md:w-[600px] md:h-[600px] bg-white/10 rounded-full blur-3xl pointer-events-none" />
 ...
 <span className="h-2 w-2 bg-white-400 rounded-full animate-ping" />
 <span className="text-zinc-200 font-semibold uppercase tracking-wider">
 AUTONOMOUS SRE INCIDENT RESPONSE
 </span>
 <span className="text-zinc-600">|</span>
 <span className="text-zinc-200 font-medium">BYOM_COMPATIBLE</span>
 </div>
 ...
 <div className="text-3xl sm:text-4xl font-bold text-zinc-200 tracking-tight">
 &lt; 2ms
 </div>
 <p className="text-xs text-zinc-400 font-sans leading-relaxed">
 ...
 <div className="text-xs font-mono text-zinc-200 uppercase tracking-widest font-semibold">
 ...
 {/* Step 1 */}
 <div className="border border-zinc-850 bg-zinc-950 p-5 space-y-3 rounded-xl relative">
 <div className="flex items-center justify-between">
 <span className="text-xs text-zinc-500 font-semibold font-mono">01. INGESTION</span>
 <span className="h-2 w-2 rounded-full bg-white-400 animate-pulse" />
 </div>
 ...
 {/* Step 4 */}
 <div className="border border-white-900/60 bg-white-950/20 p-5 space-y-3 rounded-xl relative">
 <div className="flex items-center justify-between">
 <span className="text-xs text-zinc-200 font-bold font-mono">04. APPROVAL & PR</span>
 <span className="h-2 w-2 rounded-full bg-white-400" />
 </div>
 <h4 className="text-sm font-semibold text-white uppercase tracking-wider">
 ...
 <div className="h-3 w-3 bg-white rounded-xl" />
