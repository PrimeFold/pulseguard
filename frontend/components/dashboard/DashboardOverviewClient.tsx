...
export function DashboardOverviewClient({
 ...
 <div className="flex items-center gap-2 text-xs font-mono text-zinc-200 uppercase tracking-widest bg-white-950/30 border border-white-900/60 px-2.5 py-1.5 font-medium">
 <Radio className="h-3.5 w-3.5 animate-pulse text-zinc-200" /> CLUSTER
 HEALTHY
 </div>
 </div>
 </div>
 ...
 <div
 className={`mt-1 h-2 w-2 rounded-xl shrink-0 ${
 incident.status === "OPEN"
 ? "bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.8)] animate-pulse"
 : "bg-white text-black shadow-[0_0_8px_rgba(16,185,129,0.5)]"
 }`}
 />
 ...
 <span className={incident.status === "OPEN" ? "text-red-400 font-semibold" : "text-zinc-200"}>
 {incident.status}
 </span>
 <span className="text-zinc-600">/</span>
 <span
