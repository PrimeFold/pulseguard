...
export function GitHubConnectionReminder({
 ...
 return (
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-white-950/20 border border-white/30 text-white-300 font-mono text-xs">
 <div className="flex items-center gap-3">
 <CheckCircle2 className="h-5 w-5 text-zinc-200 shrink-0" />
 <div>
 <span className="font-bold uppercase tracking-wider block text-white-200">
 ...
 <Link
 href={`/${orgSlug}/settings`}
 className="text-[10px] uppercase tracking-widest text-zinc-200 hover:text-white underline shrink-0"
 >
 View Settings →
 </Link>
 </div>
 ...
 <div className="h-9 w-9 rounded-xl bg-amber-950/40 border border-amber-800/60 flex items-center justify-center shrink-0 mt-0.5">
 ...
 asChild
 size="sm"
 className="bg-amber-400 hover:bg-amber-300 text-black border border-transparent font-mono text-[10px] font-bold uppercase tracking-wider rounded-xl h-8 px-3.5 cursor-pointer active:scale-95 transition-transform"
 >
 ...
 variant="outline"
 size="sm"
 className="border-zinc-800 bg-zinc-900/60 hover:bg-zinc-800 text-zinc-300 hover:text-white font-mono text-[10px] uppercase tracking-wider rounded-xl h-8 px-3 cursor-pointer"
 >
