...
export function GlobalLoader({
 ...
 {/* Glow backdrop */}
 <div className="absolute -top-10 h-48 w-48 bg-white/10 rounded-full blur-3xl pointer-events-none" />

 {/* Central Aerospace Reticle */}
 <div className="relative flex items-center justify-center h-24 w-24 mb-8">
 {/* Outer dashed spinning ring */}
 <div className="absolute inset-0 rounded-full border border-dashed border-white/30 animate-[spin_12s_linear_infinite]" />

 {/* Middle counter-rotating accented ring */}
 <div className="absolute inset-2 rounded-full border-t-2 border-b border-transparent border-t-white-400 border-b-zinc-800 animate-[spin_3s_linear_infinite_reverse]" />

 {/* Inner radar pulse circle */}
 <div className="absolute inset-5 rounded-full bg-white-950/30 border border-white/40 flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.25)]">
 <Activity className="h-6 w-6 text-zinc-200 animate-pulse" />
 </div>
 ...
 <span className="h-2 w-2 rounded-full bg-white-400 animate-ping" />
 ...
 <div
 className="absolute inset-y-0 left-0 bg-gradient-to-r from-transparent via-white-400 to-transparent w-1/3 animate-[scan_1.6s_ease-in-out_infinite]"
 style={{
