...
export function CreateWorkspaceForm() {
 ...
 <span className="px-3 py-1 bg-white-950/60 border border-white-800/80 text-zinc-200 font-mono text-xs font-bold uppercase tracking-wider shrink-0">
 RECOMMENDED
 </span>
 </div>
 ...
 <ShieldCheck className="h-5 w-5 text-zinc-200 shrink-0" />
 <span>Least-privilege app scoped to target repos</span>
 </div>
 <div className="flex items-center gap-3 p-3.5 bg-zinc-950 border border-zinc-800">
 <GitFork className="h-5 w-5 text-zinc-200 shrink-0" />
 ...
 <Button
 asChild
 className="w-full bg-white hover:bg-zinc-200 text-black border border-transparent font-mono text-xs sm:text-sm font-bold tracking-widest uppercase rounded-xl h-14 transition-all duration-300 active:scale-[0.98] cursor-pointer"
 >
 ...
 className="w-full bg-zinc-950 hover:bg-zinc-900 text-zinc-200 hover:text-white-300 border-white-900/60 font-mono text-xs sm:text-sm font-semibold uppercase tracking-wider rounded-xl h-12 transition-colors cursor-pointer flex items-center justify-center gap-2.5"
 >
 ...
 className="w-full bg-transparent hover:bg-zinc-900 text-zinc-400 hover:text-zinc-200 font-mono text-xs uppercase tracking-wider rounded-xl h-10 transition-colors cursor-pointer"
 >
 ...
 className="bg-black border-zinc-800 text-white font-mono text-sm sm:text-base h-14 rounded-xl placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-600 px-4"
 disabled={loading}
 required
 />
 </div>
