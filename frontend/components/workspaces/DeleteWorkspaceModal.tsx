...
export function DeleteWorkspaceModal({
 ...
 <div 
 className="relative w-full max-w-lg bg-black border border-red-950/80 shadow-[0_0_50px_rgba(239,68,68,0.15)] rounded-xl overflow-hidden space-y-6"
 ...
 onClick={onClose}
 disabled={deleting}
 className="text-zinc-500 hover:text-white transition-colors p-1.5 cursor-pointer rounded-xl disabled:opacity-50"
 >
 <X className="h-4 w-4" />
 </button>
 </div>
 ...
 disabled={deleting}
 autoFocus
 className="bg-zinc-950 border-zinc-800 text-white font-mono text-sm h-12 rounded-xl placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-red-600 px-4"
 />
 <div className="flex items-center justify-between text-xs font-mono">
 {isMatched ? (
 <span className="text-zinc-200 flex items-center gap-1 font-semibold">
 ...
 onClick={onClose}
 disabled={deleting}
 className="bg-transparent hover:bg-zinc-900 text-zinc-400 hover:text-white border-zinc-800 font-mono text-xs font-bold uppercase tracking-wider h-11 px-5 rounded-xl cursor-pointer"
 >
 Cancel
 </Button>
 <Button
 ...
 className="bg-red-600 hover:bg-red-700 text-white font-mono text-xs font-bold uppercase tracking-wider h-11 px-6 rounded-xl transition-all duration-200 active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer shadow-lg shadow-red-950/50"
 >
 {deleting ? (
 <>
