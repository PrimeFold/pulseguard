...
export function IngestionView({ organization, role }: Props) {
 const metalEndpointRef = useRef(null);
 useMetalBend(metalEndpointRef);
...
// 4. Click Save. Every deployment exception and runtime error will flow into PulseGuard automatically!`,
 ...
 <Radio className="h-6 w-6 text-zinc-200" />
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white-950/30 border border-white-800/60 text-zinc-200 font-mono text-xs uppercase tracking-wider">
 <span className="h-2 w-2 bg-white-400 animate-pulse" />
 ...
 <Card className="border-border/60 bg-black/60 backdrop-blur rounded-xl">
 ...
 <div className="flex-1 flex items-center bg-zinc-950 border border-zinc-800 px-3.5 py-2.5 font-mono text-xs text-zinc-200 overflow-x-auto selection:bg-white text-black selection:text-black">
 <span className="text-zinc-600 mr-2 shrink-0 select-none">POST</span>
 <span className="truncate">{endpointUrl}</span>
 </div>

  <div className="shrink-0">
   <MetalFx ref={metalEndpointRef} preset="chromatic" innerShadow strength={0.90}>
     <Button
     onClick={() => handleCopy(endpointUrl, "endpoint")}
     className="bg-black border border-zinc-800 text-white hover:bg-zinc-900 font-mono text-xs font-bold uppercase tracking-wider rounded-xl h-11 px-5 w-full sm:w-auto gap-2 transition-all active:scale-[0.98] cursor-pointer"
     >
     {copiedEndpoint ? (
     <>
 ...
 <div className="p-3 bg-zinc-950/80 border border-zinc-900 flex items-start gap-2.5">
 <Key className="h-4 w-4 text-zinc-200 shrink-0 mt-0.5" />
 <div>
 ...
 <div className="p-3 bg-zinc-950/80 border border-zinc-900 flex items-start gap-2.5">
 <Code2 className="h-4 w-4 text-zinc-200 shrink-0 mt-0.5" />
 <div>
 ...
 <Card className="border-border/60 bg-black/60 backdrop-blur rounded-xl flex flex-col justify-between">
 <CardHeader>
 <div className="flex items-center gap-2">
 <Key className="h-4 w-4 text-zinc-200" />
 <CardTitle className="text-sm font-mono uppercase tracking-wider text-white">
 ...
 readOnly
 className="font-mono text-xs bg-zinc-950 border-zinc-800 text-zinc-200 h-10 rounded-xl select-all"
 />
 <Button
 size="sm"
 variant="outline"
 onClick={() => handleCopy(organization.id, "key")}
 className="border-zinc-800 hover:bg-zinc-900 text-zinc-300 font-mono text-xs rounded-xl h-10 px-3 shrink-0 gap-1.5 cursor-pointer"
 >
 {copiedKey ? (
 ...
 readOnly
 className="font-mono text-xs bg-black text-amber-200 border-amber-500/40 h-9 rounded-xl select-all"
 />
 <Button
 size="sm"
 onClick={() => handleCopy(revealedRawKey, "secret")}
 className="bg-amber-400 text-black hover:bg-amber-300 font-mono text-xs h-9 rounded-xl shrink-0 gap-1 cursor-pointer"
 >
 ...
 disabled={keyLoading}
 className="gap-1.5 text-xs font-mono border-zinc-800 text-zinc-300 hover:text-white rounded-xl cursor-pointer"
 >
 ...
 testResult.success
 ? "bg-white-950/20 border-white-800/60 text-white-300"
 ...
 size="sm"
 variant="outline"
 className="border-white-700/60 text-white-300 hover:bg-white-950/40 text-[11px] font-mono rounded-xl h-8"
 >
 ...
 disabled={testing}
 className="w-full bg-white text-black hover:bg-white-400 text-black font-mono text-xs font-bold uppercase tracking-wider rounded-xl h-11 transition-all cursor-pointer"
 >
 {testing ? (
 <>
 ...
 {/* Snippet Code block */}
 <pre className="p-5 overflow-x-auto leading-relaxed text-zinc-300 selection:bg-white text-black selection:text-black">
 ...
 <tr>
 <td className="p-3 text-zinc-200">service</td>
 ...
 <tr>
 <td className="p-3 text-zinc-200">level</td>
 ...
 <tr>
 <td className="p-3 text-zinc-200">message</td>
 <td className="p-3 text-zinc-500">string</td>
 <td className="p-3 text-zinc-200 font-bold">Recommended</td>
 <td className="p-3 text-zinc-400">
 Human-readable error description, stack trace summary, or event log message.
 </td>
 </tr>
 <tr>
 <td className="p-3 text-zinc-200">metadata</td>
 ...
 <tr>
 <td className="p-3 text-zinc-200">timestamp</td>
