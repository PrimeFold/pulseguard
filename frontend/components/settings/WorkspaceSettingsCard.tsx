...
export function WorkspaceSettingsCard({
 ...
 className="bg-black border-zinc-800 text-white font-mono text-xs sm:text-sm h-12 rounded-xl placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-600 px-4"
 />
 {canManage && (
 <Button
 type="submit"
 disabled={loading || name === initialName || !name}
 className="bg-white hover:bg-zinc-200 text-black border border-transparent font-mono text-xs font-bold tracking-wider uppercase rounded-xl h-12 px-5 transition-all duration-300 active:scale-[0.98] cursor-pointer shrink-0"
 >
 {loading ? (
 ...
 value={initialSlug}
 disabled
 className="bg-zinc-950 border-zinc-900 text-zinc-400 font-mono text-xs sm:text-sm h-12 rounded-xl cursor-not-allowed px-4"
 />
 </div>
 </div>
 ...
 {updateFeedback && (
 <div
 className={`p-3.5 border font-mono text-xs uppercase rounded-xl flex items-center gap-2 ${
 updateFeedback.type === "success"
 ? "bg-white-950/30 border-white-800/60 text-zinc-200"
 ...
 className="bg-transparent hover:bg-red-950/40 text-red-500 hover:text-red-400 border border-red-900 hover:border-red-600 rounded-xl h-11 font-mono text-xs font-bold uppercase tracking-wider px-5 transition-all active:scale-[0.98] cursor-pointer"
 >
