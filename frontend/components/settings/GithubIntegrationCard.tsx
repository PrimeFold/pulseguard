...
export function GitHubIntegrationCard({
 ...
 <Badge
 variant="outline"
 className="border-white/30 bg-white/10 text-zinc-200 gap-1"
 >
 ...
 {linkSuccess && (
 <p className="text-xs text-zinc-200 bg-white-950/20 border border-white-900/40 p-2 rounded flex items-center gap-1.5">
