...
export function AiProviderCard({
 ...
 {apiKeyDisplay && (
 <div className="flex items-center gap-2 px-2 py-1 bg-white/10 border border-white/20">
 ...
 disabled={!canManage}
 className="bg-black border-zinc-900 text-zinc-100 font-mono text-xs h-8 rounded-xl placeholder:text-zinc-700 focus-visible:ring-1 focus-visible:ring-zinc-700 flex-1"
 />
 ...
 disabled={deleting}
 className="bg-transparent hover:bg-red-950/30 text-zinc-400 hover:text-red-400 border border-zinc-800 hover:border-red-900/50 rounded-xl h-8 font-mono text-[10px] uppercase tracking-widest px-4 transition-all"
 >
 {deleting ? (
 ...
 className="bg-zinc-950 border-zinc-900 text-zinc-300 font-mono text-[11px] h-8 rounded-xl focus-visible:ring-1 focus-visible:ring-zinc-700"
 />
 ) : (
 <select
 value={model}
 ...
 className="w-full bg-zinc-950 border border-zinc-900 text-zinc-300 font-mono text-[11px] h-8 px-3 rounded-xl focus:outline-none appearance-none"
 >
 ...
 ? "bg-white-950/20 text-zinc-200 border-white-900/40"
 ...
 className="bg-transparent hover:bg-zinc-900 text-zinc-400 hover:text-white border border-zinc-800 rounded-xl h-8 font-mono text-[10px] uppercase tracking-widest px-3 active:scale-[0.98]"
 >
 <RefreshCw
 ...
 className="bg-white hover:bg-zinc-200 text-black border border-transparent font-mono text-[10px] font-bold tracking-widest uppercase rounded-xl h-8 px-4 transition-all duration-300 active:scale-[0.98] cursor-pointer"
 >
