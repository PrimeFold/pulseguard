...
export function WarRoomClientContainer({
 ...
 <span className="text-zinc-600">/</span>
 <span className={incident.status === "OPEN" ? "text-red-400" : "text-zinc-200"}>
 ...
 mobileTab === "agent"
 ? "bg-zinc-900 text-zinc-200 border-b-2 border-zinc-700"
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] text-zinc-500 uppercase tracking-widest flex items-center gap-1.5 font-medium">
 <FileText className="h-3.5 w-3.5 text-zinc-200" /> Root Cause
 Analysis
 </label>
