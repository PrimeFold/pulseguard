...
export function DiffApprovalCard({
 ...
 return (
 <div className="mt-2.5 border border-zinc-800 bg-zinc-950 p-3.5 font-mono text-xs space-y-3 rounded-xl">
 {/* Header Strip */}
 ...
 {/* Code / Diff Preview */}
 <div className="relative bg-black p-3 font-mono text-xs text-zinc-200 border border-zinc-900 overflow-x-auto max-h-56 scrollbar-thin">
 ...
 className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-zinc-200 text-black hover:bg-white text-black text-white text-xs font-mono font-bold tracking-wider uppercase transition-colors"
 >
 ...
 className="h-8 text-xs px-3.5 gap-2 bg-white hover:bg-zinc-200 text-black font-mono font-bold tracking-wider uppercase rounded-xl transition-all active:scale-[0.98] cursor-pointer"
 >
 {status === "submitting" ? (
 <>
