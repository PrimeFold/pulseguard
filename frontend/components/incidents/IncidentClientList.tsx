...
export function IncidentListClient({
 ...
 case "RESOLVED":
 return (
 <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/10 border border-white/20 text-zinc-200 font-mono text-xs uppercase tracking-wider font-medium">
 ...
 className="w-full bg-black border border-zinc-800 text-white placeholder-zinc-500 text-xs sm:text-sm font-mono h-11 pl-10 pr-4 rounded-xl focus:outline-none focus:border-zinc-500 transition-colors"
 />
 </div>

 {/* Status Filter Tabs */}
 <div className="flex items-center p-1 bg-black border border-zinc-900 rounded-xl overflow-x-auto w-full sm:w-auto scrollbar-none">
 ...
 className={`
 relative px-4 py-2 text-xs font-mono tracking-wider font-semibold transition-all rounded-xl uppercase whitespace-nowrap cursor-pointer
 ${
 activeTab === tab
