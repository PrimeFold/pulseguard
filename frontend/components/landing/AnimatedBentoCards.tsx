...
export function AnimatedBentoCards() {
 ...
 <div
 key={idx}
 className="bento-card border border-zinc-800 bg-black p-4 space-y-3 text-left rounded-xl hover:border-zinc-700 hover:bg-zinc-950/20 transition-all duration-150 group relative"
 >
 <div className="h-7 w-7 bg-zinc-900 border border-zinc-800 flex items-center justify-center rounded-xl group-hover:border-zinc-700 transition-colors">
