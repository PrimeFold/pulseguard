...
export function AnimatedHeroTerminal() {
 ...
 <div
 ref={containerRef}
 className="border border-zinc-800 bg-black shadow-2xl rounded-xl overflow-hidden"
 >
 {/* Terminal Title Bar */}
 ...
 <span className="h-1.5 w-1.5 bg-white text-black rounded-xl animate-pulse" />
 LIVE SRE STREAM
 </span>
 <span>•</span>
 <span>AES-256</span>
 ...
 <div className="approval-card mt-3 border border-zinc-800 bg-zinc-950 p-2.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 rounded-xl">
 <div>
 <div className="flex items-center gap-1.5">
 <GitPullRequest className="h-3.5 w-3.5 text-zinc-200" />
 ...
 <Badge
 variant="outline"
 className="bg-white-950/40 border-white-800/60 text-zinc-200 rounded-xl text-[9px] font-mono uppercase tracking-wider py-0.5 px-1.5"
 >
