...
export function BentoArchitectureGrid() {
 ...
 <span className="text-zinc-200 font-semibold">200 OK • 1.4ms</span>
 </div>
 ...
 <code className="bg-zinc-900 px-2 py-0.5 text-zinc-200 font-bold border border-zinc-800">
 ...
 <span className="text-[11px] font-mono text-zinc-200 uppercase tracking-widest bg-white-950/30 border border-white-900/50 px-2 py-0.5">
 BYOM
 </span>
 </div>
 ...
 <span className="text-zinc-200 text-[11px]">OPTIMIZED</span>
 </div>
 ...
 <span className="text-zinc-200 font-bold">94% SIMILAR</span>
 </div>
 ...
 <div className="space-y-3">
 <div className="flex items-center justify-between">
 <div className="h-9 w-9 bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-200">
 ...
 <div className="p-3 bg-white-950/20 border border-white-900/50 space-y-1">
 <span className="text-[10px] text-zinc-200 font-bold block">STEP 03</span>
 <span className="text-white-300 font-semibold block">Engineer Sign-Off</span>
