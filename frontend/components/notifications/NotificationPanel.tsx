...
export function NotificationPanel({
 ...
 className={`relative p-2 transition-colors rounded-xl group active:scale-[0.98] cursor-pointer ${
 isOpen
 ...
 {totalCount > 0 && (
 <span className="absolute -top-1 -right-1 flex h-4 min-w-4 px-1 items-center justify-center rounded-xl bg-white text-black font-mono text-[9px] font-bold text-black shadow-sm">
 {totalCount}
 </span>
 )}
 </button>
 ...
 {isOpen && (
 <div
 className={`${positionClasses} bg-zinc-950 border border-zinc-800 shadow-2xl shadow-black/90 rounded-xl overflow-hidden z-50 flex flex-col font-sans animate-in fade-in-0 zoom-in-95 duration-150`}
 >
 {/* Header */}
 <div className="p-3.5 border-b border-zinc-800/80 bg-zinc-900/80 flex items-center justify-between shrink-0">
 <div className="flex items-center gap-2">
 <span className="h-2 w-2 rounded-xl bg-white-400 animate-pulse" />
 <span className="text-xs font-mono text-white font-bold tracking-widest uppercase">
 Action Center
 </span>
 {totalCount > 0 && (
 <span className="text-[9px] font-mono font-bold text-zinc-200 bg-white-950/60 border border-white-800/50 px-1.5 py-0.5 rounded-xl">
 {totalCount} PENDING
 </span>
 )}
 </div>
 ...
 >
 <RefreshCw
 className={`h-3.5 w-3.5 ${isLoading ? "animate-spin text-zinc-200" : ""}`}
 />
 </button>
 <button
 type="button"
 ...
 <div className="h-8 w-8 rounded-xl border border-zinc-800 bg-zinc-900/50 flex items-center justify-center text-zinc-600">
 ...
 <div className="mt-0.5 h-6 w-6 rounded-xl bg-purple-950/40 border border-purple-800/40 flex items-center justify-center text-purple-400 shrink-0">
 ...
 className="flex-1 py-1.5 bg-white hover:bg-zinc-200 text-black text-[10px] font-mono font-bold uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
 >
 ...
 className="flex-1 py-1.5 bg-transparent hover:bg-zinc-900 text-zinc-400 hover:text-white text-[10px] font-mono uppercase tracking-wider border border-zinc-800 rounded-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
 >
 ...
 className="absolute top-3 right-3 text-zinc-600 hover:text-red-400 hover:bg-zinc-900 p-1 rounded-xl transition-colors cursor-pointer"
 >
 <X className="h-3.5 w-3.5" />
 </button>
 </div>
 ...
 >
 <div className="mt-0.5 h-6 w-6 rounded-xl bg-amber-950/40 border border-amber-800/50 flex items-center justify-center text-amber-400 shrink-0">
 ...
 title="Remove notification"
 className="absolute top-3 right-3 text-zinc-600 hover:text-red-400 hover:bg-zinc-900 p-1 rounded-xl transition-colors cursor-pointer z-10"
 >
 <X className="h-3.5 w-3.5" />
 </button>
 </div>
