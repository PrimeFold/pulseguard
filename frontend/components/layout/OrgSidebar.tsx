...
export function OrgSidebar({
 ...
 className="flex items-center gap-3 p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-900/90 transition-all active:scale-[0.98] group w-full shadow-md"
 >
 ...
 onClick={onClose}
 className={cn(
 "nav-item flex items-center gap-3.5 px-3.5 py-2.5 rounded-xl text-sm transition-all duration-200 active:scale-[0.98] border border-transparent cursor-pointer",
 isActive
 ...
 {/* Autopilot SRE Status Footer with Notification Bell */}
 <div className={cn("p-5 border-t border-zinc-900 bg-zinc-950/60 relative z-10 flex flex-col gap-3", isMobile && "mt-auto")}>
 ...
 <div className="flex items-center gap-2">
 {/* Notification Bell positioned beside Autopilot SRE opening UPWARDS */}
 <NotificationPanel direction="up" toggleOnly />
 <div className="h-2 w-2 rounded-xl bg-white text-black animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.8)]" />
 </div>
 </div>
