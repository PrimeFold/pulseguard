                  ...
                  {memberships.map(({ organization: org, role }: any) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <Badge
                          variant="outline"
                          className="text-[9px] bg-zinc-950 border-zinc-800 text-zinc-400 uppercase font-mono tracking-wider rounded-none py-0.5 px-2"
                        >
                          {role}
                        </Badge>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-zinc-900 bg-zinc-950/80 text-zinc-500 text-[10px]">
                        ...
                        <th className="p-3 font-semibold tracking-wider text-right">
                          KEY CONFIG
                        </th>
                      </tr>
                    </thead>
                      ...
                      {memberships.map(({ organization: org }: any) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-3 text-zinc-400 capitalize">
                              {org.aiProvider || "None"}
                            </td>
