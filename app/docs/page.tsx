  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-white selection:text-black font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800 bg-black/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex h-12 items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-4">
            ...
            <Badge variant="outline" className="hidden sm:inline-flex bg-zinc-950 border-zinc-800 text-zinc-400 text-[9px] font-mono rounded-none uppercase px-1.5 py-0">
              SPECIFICATION_v1.0
            </Badge>
          </div>
          ...
          <div className="flex items-center gap-3 font-mono text-[10px]">
            ...
            >
              <FaGithub className="h-3 w-3" /> STAR
            </Link>
            ...
            <Link
              href="/login"
              className="px-2.5 py-1 bg-white text-black font-semibold hover:bg-zinc-200 transition-colors rounded-none"
            >
              CONSOLE &rarr;
            </Link>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-56 shrink-0 space-y-4 md:sticky md:top-16 self-start text-[11px] font-mono">
          <div className="space-y-1 border-b border-zinc-800 pb-2">
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold">// NAVIGATION</span>
          </div>

          <nav className="space-y-0.5 text-zinc-400">
            <a href="#overview" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              01. System Architecture
            </a>
            <a href="#quickstart" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              02. Local Setup &amp; Docker
            </a>
            <a href="#ingestion-api" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              03. Telemetry Ingest API
            </a>
            <a href="#fingerprinting" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              04. Anomaly Fingerprinting
            </a>
            <a href="#sre-agent" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              05. Autonomous SRE Agent
            </a>
            <a href="#pgvector-rag" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              06. pgvector Semantic RAG
            </a>
            <a href="#custom-ai" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              07. Custom AI &amp; Encryption
            </a>
            <a href="#github-hotfix" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              08. GitHub PR Hotfix Flow
            </a>
            <a href="#redis-caching" className="block px-2 py-1 hover:bg-zinc-900 hover:text-white transition-colors">
              09. Redis Caching &amp; Limits
            </a>
          </nav>

          <div className="border border-zinc-800 bg-zinc-950 p-3 space-y-1.5 text-[10px]">
        ...
        <main className="flex-1 min-w-0 space-y-12 text-left">
          {/* Section 1: Overview */}
          <section id="overview" className="space-y-3">
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-3 font-mono text-[11px] text-zinc-300 space-y-1.5">
          ...
          <section id="quickstart" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="border border-zinc-800 bg-black p-3.5 font-mono text-[11px] text-zinc-300 overflow-x-auto space-y-1.5">
              <div className="text-zinc-500">// 1. Boot up Docker containers</div>
              <div className="text-emerald-400">docker-compose up -d</div>
              <div className="text-zinc-500 pt-1.5">// 2. Push Prisma database schema &amp; generate client</div>
              <div className="text-emerald-400">bunx prisma db push &amp;&amp; bunx prisma generate</div>
              <div className="text-zinc-500 pt-1.5">// 3. Start local Next.js dev server</div>
              <div className="text-emerald-400">bun run dev</div>
            </div>
          </section>

          {/* Section 3: Ingestion API */}
          <section id="ingestion-api" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-2.5 font-mono text-[11px] text-zinc-300 flex items-center justify-between">
              <div>
                <span className="text-emerald-400 font-bold">POST</span> <span className="text-white">/api/telemetry/ingest</span>
              </div>
              <Badge variant="outline" className="rounded-none bg-black border-zinc-800 text-[9px] text-zinc-400 font-mono py-0 px-1">
                RATE_LIMIT: 50/min
              </Badge>
            </div>
...
{`curl -X POST https://your-domain.com/api/telemetry/ingest \\
  ...
  -d '{
    ...
    "metadata": { "statusCode": 500, "region": "us-east-1" }
          ...
          <section id="fingerprinting" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <p className="text-xs text-zinc-400 font-sans">
              To prevent alert fatigue, dynamic variables (UUIDs, timestamps, hex tokens, numeric IDs, IP addresses) are sanitized into canonical representations before SHA-256 hashing.
            </p>

            <div className="border border-zinc-800 bg-black p-3 font-mono text-[11px] space-y-2">
          ...
          {/* Section 5: SRE Agent */}
          <section id="sre-agent" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono text-[11px]">
              <div className="border border-zinc-800 bg-zinc-950 p-3.5 space-y-1 rounded-none">
                <div className="text-zinc-200 font-semibold">1. query_telemetry_logs</div>
                <p className="text-zinc-500 font-sans text-[10px]">
          ...
          <section id="pgvector-rag" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="border border-zinc-800 bg-black p-3 font-mono text-[11px] text-zinc-300 overflow-x-auto space-y-1">
...
VALUES (gen_random_uuid(), document_id, chunk_index, chunk_content, chunk_vector::vector, NOW());`}
          ...
          <section id="custom-ai" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-3 font-mono text-[11px] space-y-1">
          ...
          {/* Section 8: GitHub PR */}
          <section id="github-hotfix" className="space-y-3 border-t border-zinc-800 pt-8">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="border border-zinc-800 bg-black p-3 font-mono text-[11px] text-zinc-400 space-y-1">
          ...
          <section id="redis-caching" className="space-y-3 border-t border-zinc-800 pt-8 pb-12">
            <div className="flex items-center gap-1.5 font-mono text-[10px] text-zinc-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono text-[11px]">
              <div className="border border-zinc-800 bg-zinc-950 p-3 space-y-0.5 rounded-none">
                <span className="text-zinc-500 text-[9px]">CACHE: RATE_LIMIT</span>
                <p className="text-zinc-200 font-semibold">60s Sliding IP Window</p>
                <p className="text-zinc-500 font-sans text-[10px]">Atomic INCR + PEXPIRE counters.</p>
              </div>
              <div className="border border-zinc-800 bg-zinc-950 p-3 space-y-0.5 rounded-none">
                <span className="text-zinc-500 text-[9px]">CACHE: INCIDENT_LOOKUP</span>
                <p className="text-zinc-200 font-semibold">300s Fingerprint Cache</p>
                <p className="text-zinc-500 font-sans text-[10px]">Bypasses DB on log floods.</p>
              </div>
              <div className="border border-zinc-800 bg-zinc-950 p-3 space-y-0.5 rounded-none">
                <span className="text-zinc-500 text-[9px]">CACHE: AI_MODELS</span>
                <p className="text-zinc-200 font-semibold">24h Provider Catalog</p>
                <p className="text-zinc-500 font-sans text-[10px]">Instant UI settings rendering.</p>
              </div>
            </div>
          </section>
        </main>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-800 py-6 px-4 sm:px-6 max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[10px] text-zinc-500">
